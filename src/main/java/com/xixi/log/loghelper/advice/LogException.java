...
public class LogException extends RuntimeException {
    ...
    public LogException(Integer code, String msg, String event) {
        super(msg);
        this.code = code;
        this.msg = msg;
        this.event = event;
     ...
     * @param ex  异常
     */
    public LogException(String msg, Throwable ex) {
        super(ex);
        this.msg = msg;
    }
     ...
     * @param params 参数
     */
    public LogException(String msg, String[] params) {
        this.msg = msg;
        this.params = params;
    }
     ...
     */
    public LogException(Integer code, String msg, Map<String, Object> otherInfo) {
     ...
     * @param params 参数
     */
    public LogException(String msg, Throwable ex, String[] params) {
        super(ex);
        this.msg = msg;
        this.params = params;
    }
